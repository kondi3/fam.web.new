...
const handleContactForm = () => {
  form.post(route('site.notify'))
}
</script>

<template>
  <section class="bg-white w-ful lg:h-screen lg:max-w-7xl mx-auto">
    <div class="w-full h-full px-6 py-12 mx-auto">
      <div class="w-full h-full lg:flex lg:items-center lg:-mx-6">
          ...
          <div class="mt-6 space-y-8 md:mt-8">
            <p class="flex items-start -mx-2">
              ...
              <span class="mx-2 text-gray-700 w-72">
                The Secretariat, Fight Aids Malawi Lilongwe 3, Malawi
              </span>
            </p>
        ...
        <div class="mt-8 lg:w-1/2 lg:mx-6">
          ...
          >
            ...
            <p class="mt-2 text-sm text-gray-500">
              Reach out to us through our below contact form, we will reach back to you as soon as possible.
            </p>

            <form class="mt-6" @submit.prevent="handleContactForm">
              <div class="flex-1">
              ...
              <button
                ...
                type="submit"
                class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform disabled:bg-gray-500 bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
              >
                get in touch
              </button>
            </form>
